...
public class getSubTotalTest{

    @Test
    void getSubTotal() throws SQLException, ParseException {
        ...
        int subTotal = media1.getPrice() + media2.getPrice();
        assertEquals(subTotal, order.getSubTotal(), "Total amount should be calculated correctly");
    }
}
