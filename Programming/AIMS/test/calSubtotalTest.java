...
public class calSubtotalTest{
    ...
    public void test() throws SQLException, ParseException {
        ...
        CD cd1 = new CD(3, "cd", "Music", 20, 10, 200, true, "Artist ABC", "Record Label XYZ", "Pop", parsedDate, "Track 1, Track 2");
        DVD dvd1 = new DVD(5, "Movie 2", "Film", 20, 8, 180, true, "DVD-RW", "Director ABC", 135, "Studio XYZ", "Subtitle 3, Subtitle 4",parsedDate, "French");
        ...
        assertEquals(cartMedia1.getQuantity()*cartMedia1.getPrice()+cartMedia2.getQuantity()*cartMedia2.getPrice()+cartMedia3.getQuantity()*cartMedia3.getPrice(), cart.calSubtotal());
    }
}